...
![](pathname:///doc-img/en-blueprints-intro-1.webp)
...
![](pathname:///doc-img/en-blueprints-intro-2.webp)
...
<p class="img-desc">Source: https://developpaper.com/unity-realizes-facial-expression-transition-and-switching-animation-tutorial-through-blendshape/</p>
...
![](pathname:///doc-img/en-blueprints-intro-3.webp)
...
![](pathname:///doc-img/en-blueprints-intro-4.webp)
...
![](/doc-img/en-blueprints-intro-5.webp)
...
![](pathname:///doc-img/en-blueprints-intro-6.webp)
<p class="img-desc">Oops...</p>
...
![](pathname:///doc-img/en-blueprints-intro-8.webp)

In Warudo, a corresponding blueprint looks like this:

![](pathname:///doc-img/en-blueprints-intro-9.webp)
...
* <b style={{color: "green"}}>Green ports</b>: Determine the order in which the nodes are executed. In this blueprint, the `Set Character Tracking BlendShapes` node is executed after the `On Update` node has been executed.
...
<div className="video-box"><video controls loop src="https://user-images.githubusercontent.com/3406505/180726572-9ddcf9c5-0473-4cdc-b152-ef9ba93853eb.mp4" /></div>
...
![](pathname:///doc-img/en-blueprints-intro-10.webp)
...
![](pathname:///doc-img/en-blueprints-intro-11.webp)
...
![](pathname:///doc-img/en-blueprints-intro-12.webp)
...
<div className="video-box"><video controls loop src="https://user-images.githubusercontent.com/3406505/180735646-3f4a6324-938f-404c-9500-1f47481ab887.mp4" /></div>

Nice! But it looks like I have difficulty closing my eyes. Hmm. Let's try to fix it:

![](pathname:///doc-img/en-blueprints-intro-13.webp)
...
<div className="video-box"><video controls loop src="https://user-images.githubusercontent.com/3406505/180757257-c815210a-74eb-4adb-8bc8-d867bb572e44.mp4" /></div>
...
![](pathname:///doc-img/en-blueprints-intro-14.webp)

（`笑い` is the blendshape for the `^^-eyes` on this model.）

Let's try it out!

<div className="video-box"><video controls loop src="https://user-images.githubusercontent.com/3406505/180759207-28d1e5b5-c575-4f42-b127-afb20a2c3608.mp4" /></div>
...
![](pathname:///doc-img/en-blueprints-intro-15.webp)

No more weird eyelids!

<div className="video-box"><video controls loop src="https://user-images.githubusercontent.com/3406505/180760044-f899f4df-7064-441d-bb6f-b1305899a6a4.mp4" /></div>
...
![](pathname:///doc-img/en-blueprints-intro-16.webp)
