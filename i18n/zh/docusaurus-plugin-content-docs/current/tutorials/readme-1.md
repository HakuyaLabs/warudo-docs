...
![](pathname:///doc-img/zh-tutorials-1.webp)

创建完毕后，资源列表应该是这样的：

![](pathname:///doc-img/zh-tutorials-2.webp)
...
![](pathname:///doc-img/zh-tutorials-16.webp)

「面部追踪模板」选择 RhyLive。下面会有选项询问想要使用哪种 BlendShape 映射；绝大多数情况下使用默认自动选择即可。

![](pathname:///doc-img/zh-tutorials-17.webp)
...
![](pathname:///doc-img/zh-tutorials-21.webp)
...
![](pathname:///doc-img/zh-tutorials-22.webp)

资源列表中多出来了「RhyLive 接收器」，用来接收 RhyLive App 发送的动捕数据：

![](pathname:///doc-img/zh-tutorials-23.webp)

蓝图列表中也多出来了两个蓝图：

![](pathname:///doc-img/zh-tutorials-24.webp)
...
![](pathname:///doc-img/zh-tutorials-25.webp)

:::info
如果不知道电脑的 IP，可以在「RhyLive 接收器」的配置页面查看：

![](pathname:///doc-img/zh-tutorials-26.webp)
...
![](pathname:///doc-img/zh-tutorials-27.webp)
...
![](pathname:///doc-img/zh-tutorials-28.webp)

没有问题的话，就能看到表情导入成功：

![](pathname:///doc-img/zh-tutorials-29.webp)

你可以展开并且详细配置每个表情，比如切换到该表情时，是否应该禁用眨眼追踪：

![](pathname:///doc-img/zh-tutorials-30.webp)

不过，表情是导入进来了，我们要怎么触发它们呢？点击「生成按键绑定蓝图」就好啦：

![](pathname:///doc-img/zh-tutorials-31.webp)

![](pathname:///doc-img/zh-tutorials-32.webp)

注意到蓝图列表中多出来一个叫「表情按键绑定」的蓝图：

![](pathname:///doc-img/zh-tutorials-33.webp)
...
![](pathname:///doc-img/zh-tutorials-35.webp)

Warudo 内置超过 500 个待机动画，我们选择一个猫猫手吧：

![](pathname:///doc-img/zh-tutorials-36.webp)

然后就是这样的效果啦！

![](pathname:///doc-img/zh-tutorials-37.webp)

最棒的是，动捕可以如常运作哦！举起手让 RhyLive 捕捉到时，就会淡入到捕捉到的姿势；放下手时，就会淡出到待机动画的姿势，像下面这样：

![](pathname:///doc-img/zh-tutorials-38.webp)
## 小结
